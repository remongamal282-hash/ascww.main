    ...
    return (
        <section id="home" className="relative overflow-hidden bg-[#0a3555]">
            <div className="hero-slider absolute inset-0 z-0" aria-hidden="true">
                <div className="hero-slide is-active" style={{ backgroundImage: "url('/images/slider/1.jpg')" }} data-title="معامل علي اعلي مستوي" data-subtitle="الاهتمام بمعايير منظمة الصحة العالمية للتاكد من جودة المياه بأحدث المعايير والتقنيات" data-link="https://ascww.org/lab-of-company-water" data-cta="تعرف علي المزيد"></div>
                ...
                <div className="hero-slide" style={{ backgroundImage: "url('/images/slider/3.jpg')" }} data-title="شركة مياه الشرب والصرف الصحي بأسيوط والوادي الجديد" data-subtitle="ترحب بكم و نفخر بأننا احدي الشركات الرائده في جمهوريه مصر العربيه" data-link="https://ascww.org/an-elsherka" data-cta="تعرف علي المزيد"></div>
                <div className="hero-slide" style={{ backgroundImage: "url('/images/slider/4.jpg')" }} data-title="الإداره العامه للتدريب" data-subtitle="متاح حجز قاعات التدريب من داخل و خارج الشركة" data-link="https://ascww.org/general-admin-training" data-cta="تعرف علي المزيد"></div>
                <div className="hero-slide" style={{ backgroundImage: "url('/images/slider/5.jpg')" }} data-title="مركز خدمة العملاء" data-subtitle="مراكز خدمه العملاء وطرق التواصل وعنوان أقرب فرع" data-link="https://ascww.org/call-center" data-cta="تعرف علي المزيد"></div>
                <div className="hero-slide" style={{ backgroundImage: "url('/images/slider/6.jpg')" }} data-title="لتنزيل برنامج الخط الساخن اضغط هنا" data-subtitle="" data-link="https://ascww.org/hotline125" data-cta="فتح الخدمة"></div>
            </div>
